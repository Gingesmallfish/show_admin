    ...
    <div class="top p-3">
      <el-row :gutter="10">
        <el-col :span="6" :offset="0" v-for="(item, index) in list" :key="index">
          <el-card shadow="hover" class="relative md-3" :body-style="{ 'padding': 0 }">
            <el-image :src="item.url" fit="cover" class="w-full h-[150px]" :preview-src-list="[item.url]"
              :initial-index="0" style="width: 100%;"></el-image>
...
.image-title {
  ...
  right: -1px;
  cursor: pointer;
  @apply text-sm truncate text-gray-100 bg-opacity-50 bg-gray-800 px-2 px-1;
}
</style>
